...
import { Calendar, Clock, MapPin, Users, Target, ArrowLeft, ExternalLink } from "lucide-react";
        ...
        <main className="pt-32 pb-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-muted-foreground mb-8">
              O evento que você está procurando não foi encontrado. Pode ter sido removido ou o endereço pode estar incorreto. Que tal explorar nossos outros eventos?
            </p>
            <Link to="/">
              <Button>
      ...
      <section className="relative pt-16 lg:pt-20">
        <div className="relative h-[400px] lg:h-[500px] overflow-hidden">
          <div
            ...
            style={{ 
              backgroundImage: `url("${encodeURI(getMobileBanner(fixImagePath(event.image), isMobile))}")`,
            }}
          />
          {/* Overlay apenas no mobile */}
          <div className="absolute inset-0 hero-overlay lg:hidden" />
          
          {/* Conteúdo apenas no mobile */}
                ...
                <div className="bg-muted/50 rounded-xl p-6 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground">{event.city} - {event.state}</p>
                    </div>
                  </div>
                </div>
